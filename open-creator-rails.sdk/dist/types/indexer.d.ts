...
export declare const INDEXER_SUBSCRIPTION_LIST_ORDER_BY: "endTime";
export declare const INDEXER_SUBSCRIPTION_LIST_ORDER_DIRECTION: IndexerOrderDirection;
/** Default sort for `assets` list queries (v2 GraphQL). */
export declare const INDEXER_ASSET_ENTITY_LIST_ORDER_BY: "id";
export declare const INDEXER_ASSET_ENTITY_LIST_ORDER_DIRECTION: IndexerOrderDirection;
...
export type OcrSdkIndexer = {
    ...
    getAsset: (params: {
        assetAddress: Address;
    }) => Promise<IndexerAssetEntity | null>;
